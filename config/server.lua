return {
    ...
    money = {
        ---@alias MoneyType 'money' | 'bank' | 'crypto'
        ---@alias Money {money: number, bank: number, crypto: number}
        ---@type Money
        moneyTypes = { money = 500, bank = 5000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
        dontAllowMinus = { 'money', 'crypto' }, -- Money that is not allowed going in minus
