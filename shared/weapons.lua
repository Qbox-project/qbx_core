...
return {
    ...
    [`weapon_unarmed`]               = {
        ...
        ammotype = nil,
        damagereason =
        'Melee killed / Whacked / Executed / Beat down / Murdered / Battered'
    },
    [`weapon_dagger`]                = {
        name = 'weapon_dagger',
        label = 'Dagger',
    ...
    [`weapon_microsmg`]              = {
        ...
        ammotype = 'AMMO_SMG',
        damagereason =
        'Riddled / Drilled / Finished / Submachine Gunned'
    },
    [`weapon_smg`]                   = {
        name = 'weapon_smg',
        label = 'SMG',
    ...
    [`weapon_assaultrifle`]          = {
        ...
        ammotype = 'AMMO_RIFLE',
        damagereason =
        'Ended / Rifled / Shot down / Floored'
    },
    ...
    [`weapon_rpg`]                   = {
        ...
        ammotype = 'AMMO_RPG',
        damagereason =
        'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated'
    },
    ...
    [`weapon_grenade`]               = {
        ...
        ammotype = nil,
        damagereason =
        'Bombed / Exploded / Detonated / Blew up'
    },
    [`weapon_bzgas`]                 = {
        name = 'weapon_bzgas',
        label = 'BZ Gas',
